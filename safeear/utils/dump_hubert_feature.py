...
import sys
import tqdm
sys.path.append('../../fairseq/') # we recommend an abosulte path here.
import fairseq
...
def dump_feature(reader,audio_dir,save_dir):
    ...
    audio_files = list(audio_dir.glob("audio.flac"))
...
if __name__ == "__main__":
    ...
    parser.add_argument("--save_dir", default="../../feat")
   
    parser.add_argument("--ckpt_path", default="../../Hubert_base_ls960.pt")
